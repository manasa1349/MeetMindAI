  ...
  return (
    <div className="meeting-detail-container">
      ...
      <div className="meeting-detail-info">
        ...
        <div>
          <strong>Status:</strong> {meeting?.aiStatus || (meeting?.transcript?.length ? 'processed' : 'pending')}
        </div>
      </div>

      <div className="meeting-detail-actions" style={{ marginTop: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
        <button className="btn btn-primary" onClick={() => onNavigate('meeting-room', meetingId)}>
          Join Meeting Room
        </button>
